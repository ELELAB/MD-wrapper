...
for num in xrange(0, len(pdb_list)):
	...
	start_output = tools.Pdb2gmx(f=pdb_list[num],o='start.gro',water=water_model,p='start.top',ff=force_field,ignh=True)
	start_output.run()
	...
	shutil.copyfile(_directory+'/'+directory_name+'/'+modelname+'/'+'md/0-start/start.gro', 'start.gro')
	shutil.copyfile(_directory+'/'+directory_name+'/'+modelname+'/'+'md/0-start/start.top', 'start.top')
	...
	os.chdir(minimize)
	# Copy the neccessary file into the current work-directory
	shutil.copyfile(_directory+'/'+directory_name+'/'+modelname+'/'+'md/1-box/wbox.gro', 'wbox.gro')
	shutil.copyfile(_directory+'/'+directory_name+'/'+modelname+'/'+'md/1-box/start.top', 'start.top')	
	...
	os.chdir(ions)
	# Copy the neccessary file into the current work-directory
	shutil.copyfile(_directory+'/'+directory_name+'/'+modelname+'/'+'md/2-min/confout.gro', 'conf.gro')
	shutil.copyfile(_directory+'/'+directory_name+'/'+modelname+'/'+'md/2-min/start.top', 'start.top')	
	...
	os.chdir(minions)
	# Copy the neccessary file into the current work-directory
	shutil.copyfile(_directory+'/'+directory_name+'/'+modelname+'/'+'md/3-ions/ions.gro', 'ions.gro')
	shutil.copyfile(_directory+'/'+directory_name+'/'+modelname+'/'+'md/3-ions/start.top', 'start.top')	
	# From the supplied folder 'Files', copy necessary files 	
	shutil.copyfile(_directory+'/'+'Files/min.mdp', 'min.mdp')
	...
	os.chdir(equil)
	# Copy the neccessary file into the current work-directory
	shutil.copyfile(_directory+'/'+directory_name+'/'+modelname+'/'+'md/4-min.ions/confout.gro', 'conf.gro')
	shutil.copyfile(_directory+'/'+directory_name+'/'+modelname+'/'+'md/4-min.ions/start.top', 'start.top')
	# From the supplied folder 'Files', copy necessary files 	
	...
	os.chdir(prenvt)
	# Copy the neccessary file into the current work-directory
	shutil.copyfile(_directory+'/'+directory_name+'/'+modelname+'/'+'md/5-equil/confout.gro', 'conf.gro')
	shutil.copyfile(_directory+'/'+directory_name+'/'+modelname+'/'+'md/5-equil/start.top', 'start.top')
	shutil.copyfile(_directory+'/'+directory_name+'/'+modelname+'/'+'md/5-equil/posre.itp', 'posre.itp')
	# From the supplied folder 'Files', copy necessary files 	
	#shutil.copytree(_directory+'/'+'Files/charmm22st.ff/', 'charmm22st.ff/')
	...
	os.chdir(npt)
	# Copy the neccessary file into the current work-directory
	shutil.copyfile(_directory+'/'+directory_name+'/'+modelname+'/'+'md/6-pre.nvt/confout.gro', 'conf.gro')
	shutil.copyfile(_directory+'/'+directory_name+'/'+modelname+'/'+'md/6-pre.nvt/start.top', 'start.top')
	shutil.copyfile(_directory+'/'+directory_name+'/'+modelname+'/'+'md/6-pre.nvt/posre.itp', 'posre.itp')
	# From the supplied folder 'Files', copy necessary files 	
	#shutil.copytree(_directory+'/'+'Files/charmm22st.ff/', 'charmm22st.ff/')
	...
	npt_mdrun_output = tools.Mdrun(s='npt.tpr', nt=no_of_cores)
	...
	os.chdir(eq)
	# Copy the neccessary file into the current work-directory
	shutil.copyfile(_directory+'/'+directory_name+'/'+modelname+'/'+'md/7-npt/confout.gro', 'conf.gro')
	shutil.copyfile(_directory+'/'+directory_name+'/'+modelname+'/'+'md/7-npt/start.top', 'start.top')
	shutil.copyfile(_directory+'/'+directory_name+'/'+modelname+'/'+'md/7-npt/posre.itp', 'posre.itp')
	# From the supplied folder 'Files', copy necessary files 	
	#shutil.copytree(_directory+'/'+'Files/charmm22st.ff/', 'charmm22st.ff/')
	...
	eq_mdrun_output = tools.Mdrun(s='eq.tpr', nt=no_of_cores)
	eq_mdrun_output.run()
	...
	shutil.copyfile(_directory+'/'+directory_name+'/'+modelname+'/'+'md/8-eq/confout.gro', 'conf.gro')
	shutil.copyfile(_directory+'/'+directory_name+'/'+modelname+'/'+'md/8-eq/start.top', 'start.top')
	shutil.copyfile(_directory+'/'+directory_name+'/'+modelname+'/'+'md/8-eq/posre.itp', 'posre.itp')
	# From the supplied folder 'Files', copy necessary files 
	#shutil.copytree(_directory+'/'+'Files/charmm22st.ff/', 'charmm22st.ff/')
